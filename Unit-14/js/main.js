...
function loadWeather() {
    ...
    var conditionsPath = `http://api.wunderground.com/api/f0ddd4d2e565eb0d/conditions/q/${zip}.json`;
    var forecastPath = `http://api.wunderground.com/api/f0ddd4d2e565eb0d/forecast/q/${zip}.json`;
...
weatherConditions.onload = function () {
    if (weatherConditions.status === 200) {
        ...
        document.getElementById('temperature').innerHTML = cObj.current_observation.temp_f + "&#176";
...
weatherForecast.onload = function () {
    if (weatherForecast.status === 200) {
        ...
        document.getElementById('r1c3').innerHTML = fObj.forecast.simpleforecast.forecastday[1].high.fahrenheit + "&#176";

        document.getElementById('r1c4').innerHTML = fObj.forecast.simpleforecast.forecastday[1].low.fahrenheit + "&#176";
        ...
        document.getElementById('r2c3').innerHTML = fObj.forecast.simpleforecast.forecastday[2].high.fahrenheit + "&#176";

        document.getElementById('r2c4').innerHTML = fObj.forecast.simpleforecast.forecastday[2].low.fahrenheit + "&#176";
        ...
        document.getElementById('r3c3').innerHTML = fObj.forecast.simpleforecast.forecastday[3].high.fahrenheit + "&#176";

        document.getElementById('r3c4').innerHTML = fObj.forecast.simpleforecast.forecastday[3].low.fahrenheit + "&#176";
